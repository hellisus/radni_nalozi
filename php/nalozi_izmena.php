            ...
            <div class="mx-auto bg-white p-16">
                <div class="col s12 center">
                    <div class="row main_content">
                        <h3 class="text-center text-3xl mb-5">Nalog broj <span class="text-3xl font-bold"><?php echo $_GET['id'] ?></span> </h3>
                    </div>
                </div>
                ...
                <div id="accordion-collapse" data-accordion="collapse">
                    ...
                    $nalog = $podatci2->select(['*'], ['*'], "SELECT * FROM `nalozi` WHERE status_id = 1 AND direkcija ='" . $_GET['direkcija'] . "'");
                    $i = 0;
                    foreach ($nalog as $podatak_nalog) : ?>
                        <!-- Zaglavlje akordiona -->
                        <h2 id="accordion-collapse-heading-<?php echo $podatak_nalog['br_naloga'] ?>">
                            <button type="button" class="flex items-center focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-300 justify-between p-5 w-full font-medium text-left border border-gray-200 dark:border-gray-700 border-b-0 text-gray-900 dark:text-white bg-gray-100 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-800 -t-xl" data-accordion-target="#accordion-collapse-body-<?php echo $podatak_nalog['br_naloga'] ?>" aria-expanded="<?php if ($i == 0) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        echo "true";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        echo "false";
