...
<head>
    ...
    <title>Sr Nalozi --- Odjava sa sistema</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="grid grid-cols-1 grid-rows-1 items-center h-screen justify-items-center">
        <div
            ...
            <h1 class="pt-3 text-xl font-semibold">Odjavljeni ste sa sistema usled neaktivnosti</h1>
            <p class="pb-3 text-xl font-semibold">Prijavite se ponovo</p>
            <button
                ...
                onclick="to_hp()">Povratak na prijavu na sistem</button>
        </div>
    </div>
