            ...
            <div class="mx-auto bg-white p-16">
                <div class="col s12 center">
                    <div class="row main_content">
                        <h3 class="text-center text-3xl mb-5">Nalozi tipa <span class="text-3xl font-bold"><?php echo $_GET['tip'] ?> u KG</span> </h3>
                    </div>
                </div>
                ...
                <div id="accordion-collapse" data-accordion="collapse">
                    ...
                    $nalog = $podatci2->select(['*'], ['*'], "SELECT * FROM `nalozi` WHERE status_id <= 2 AND nalozi.direkcija = 'Kragujevac' AND tip_naloga ='" . $_GET['tip'] . "' ORDER BY " . "vreme_prijema DESC");
                    $i = 0;
                        ...
                        <div id="accordion-collapse-body-<?php echo $podatak_nalog['br_naloga'] ?>" aria-labelledby="accordion-collapse-heading-<?php echo $podatak_nalog['br_naloga'] ?>">
                            ...
                            <div class="p-5 border border-gray-200 dark:border-gray-700 dark:bg-gray-200 border-b-0">
                                <div class="grid gap-6 mb-6 md:grid-cols-2">
                                    ...
                                    <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onclick="snimi_zakazivanje(<?php echo  $podatak_nalog['nalozi_id']; ?>)">Snimi izmene</button>
