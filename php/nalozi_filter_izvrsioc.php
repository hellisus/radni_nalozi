            ...
            <div class="mx-auto bg-white p-16">
                <div class="col s12 center">
                    <div class="row main_content">
                        <h3 class="text-center text-3xl mb-5">Nalozi zaduženi na <span class="text-3xl font-bold"><?php echo $_GET['ime'] ?> <?php echo $_GET['prezime'] ?></span> </h3>
                    </div>
                </div>
                ...
                <div id="accordion-collapse" data-accordion="collapse">
                    ...
                    $nalog = $podatci2->select(['*'], ['*'], "SELECT * FROM `nalozi` WHERE kome_zaduzen ='" . $_GET['izvrsioc'] . "' AND status_id <= 2 ORDER BY " . "vreme_prijema DESC");
                    $i = 0;
